...
def create_database():
    ...
    df_database_external = pd.read_csv(external_database_path)
    ...
    df_database = combine_dataframes(
        df_database_sydney_uni=df_database, df_database_others=df_database_external
    )
    # Adjust decimal places for better readability
