...
def main():
    ...
    try:
        ...
        if all_averages:
            ...
            reordered_combined_averages = match_nearest_datetime(df_manikin=combined_averages, df_chamber=df_chamber)
            ...
            logging.info(combined_averages)
            ...
            logging.info("delta_results:", delta_results_with_extracted_info)
