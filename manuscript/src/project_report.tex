...
This database will help researcher understand the impact of PCS on thermal comfort and be a valuable resource for comfort simulations, potentially building upon existing tools for thermal comfort research \cite{Tartarini2020a}.
...
\begin{figure}[h!]
    \centering
    % Use relative path; actual file is in repo's figure/ directory
